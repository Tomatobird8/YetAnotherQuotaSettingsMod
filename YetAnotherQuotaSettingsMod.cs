...
namespace YetAnotherQuotaSettingsMod
{
    ...
    public class YetAnotherQuotaSettingsMod : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            onlyChangeCurve = Config.Bind<bool>("General", "Only Change Curve", false, "Only change the randomizer curve and skip applying any other settings. You may want to toggle this if you have another mod changing these settings.").Value;
