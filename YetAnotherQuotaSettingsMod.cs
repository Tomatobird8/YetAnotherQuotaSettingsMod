...
namespace YetAnotherQuotaSettingsMod
{
    ...
    public class YetAnotherQuotaSettingsMod : BaseUnityPlugin
    {
        ...
        // public static bool simpleCurve;
        ...
        private void Awake()
        {
            ...
            // simpleCurve = Config.Bind<bool>("General", "Simple Curve", true, "True: each key for Randomizer Curve takes 2 arguments: time,value. False: each key for Randomizer Curve takes 7 arguments: ").Value;
